...
.. note::
   ...
   This project is under active development. Last edit made on 16 Aug 2022 by RJC
...
we currently have a total of 2 V100s (32 GB of RAM each) and 10 A100s (40 GB of RAM each) [More A100s are in Norman, and will be installed soon!].
...
Side note, for regular users, please check out the #schooner channel on the AI2ES slack to see the latest about
node status and other supercomputer issues. 
